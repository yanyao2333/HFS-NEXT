...
export async function getExamOverviewAction(token: string, examId: string): Promise<{payload?: object, ok: boolean, errMsg?: string}> {
...
export async function getExamRankInfoAction(token: string, examId: string): Promise<{payload?: object, ok: boolean, errMsg?: string}> {
...
export async function getAnswerPictureAction(token: string, paperId: string, pid: string, examId: string): Promise<{payload?: object, ok: boolean, errMsg?: string}> {
...
export async function getPaperRankInfoAction(token: string, examId: string, paperId: string): Promise<{payload?: object, ok: boolean, errMsg?: string}> {
