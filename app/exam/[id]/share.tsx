...
const JWT_SECRET_KEY = "hfs-next-is-best"

export default function Share({onClose, token}: { onClose: any, token: string }) {
        ...
        <div className="fixed inset-0 z-50 overflow-auto bg-gray-500 bg-opacity-75 flex justify-center items-center">
            <div
                ...
                <div className="flex justify-between items-center border-b pb-2 mb-4">
                    <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">分享考试</h2>
                ...
                <div>
                    ...
                    {/*                <li key={index}*/}
                    {/*                    className={(index === nowStage) ? "text-yellow-500" : (index > nowStage) ? "text-gray-400" : "text-green-500"}>*/}
                    {/*                    {stage.name}：{(index === nowStage) ? "处理中..." : (index > nowStage) ? "未处理" : "已完成"}*/}
                    {/*                </li>*/}
                    {/*            ))}*/}
                    {/*        </ul>*/}
